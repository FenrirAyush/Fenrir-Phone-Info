...
def display_vehicle_info(vehicle_data):
    ...
    console.print(table)
    console.print(Text("✅ Data extraction complete by [bold green]Vicky[/bold green]", justify="center", style="cyan"))
...
╚██╗ ██╔╝██║██║     ██╔═██╗   ╚██╔╝  
 ╚████╔╝ ██║╚██████╗██║  ██╗   ██║   
  ╚═══╝  ╚═╝ ╚═════╝╚═╝  ╚═╝   ╚═╝   
[/bold cyan]
[bold green]   VEHICLE INFO & MULTI-TOOL v2.0[/bold green]
[bold white]       Created by: [bold yellow]Vicky[/bold yellow] [/bold white]
"""
